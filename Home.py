...
if check_password():
   ...
   with st.expander("11. Термін дії Договору"):
      st.caption(f"""11.1 Даний Договір  набирає чинності з моменту підписання його Сторонами і діє до 31.12.2022.""")
   ...
   with st.expander(""""12. Додатки до договору"""):
      ...
      в обсязі {input2} тепловоза серії {input10} №{input11} на 2022 рік у виробничому структурному підрозділі «Локомотивне депо Львів-Захід» 
      регіональної філії «Львівська залізниця» акціонерного товариства «Українська залізниця» для ПрАТ «Львівський локомотиворемонтний завод» 
      на 1 (одному) аркуші.""")
