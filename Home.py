...
if check_password():
   ...
   if select_cat == "Договір на послуги з ремонту тепловозу":
      ...
      with st.expander("1. Предмет договору"):
         ...
         init_change = st.button("Змінити", key=1)
         if init_change:
      ...
      with st.expander("2. Вартість послуг і умови розрахунку"):
         ...
         init_change = st.button("Змінити", key=2)
         if init_change:
            st.error("""Внесення змін до цього розділу потребуватиме погодження
                     таких підрозділів: Ц..., Ц..., Ц...""")
      ...
      with st.expander("3. Умови та місце наданих послуг"):
         ...
         init_change = st.button("Змінити", key=3)
         if init_change:
            st.error("""Внесення змін до цього розділу потребуватиме погодження
                     таких підрозділів: Ц..., Ц..., Ц...""")
      ...
      with st.expander("4. Порядок приймання-передачі наданих послуг"):
         ...
         init_change = st.button("Змінити", key=4)
         if init_change:
            st.error("""Внесення змін до цього розділу потребуватиме погодження
                     таких підрозділів: Ц..., Ц..., Ц...""")
      ...
      with st.expander("5. Обставини непереборної сили"):
         ...
         init_change = st.button("Змінити", key=5)
         if init_change:
            st.error("""Внесення змін до цього розділу потребуватиме погодження
                     таких підрозділів: Ц..., Ц..., Ц...""")
      ...
      with st.expander("6. Відповідальність сторін"):
         ...
         init_change = st.button("Змінити", key=6)
         if init_change:
            st.error("""Внесення змін до цього розділу потребуватиме погодження
                     таких підрозділів: Ц..., Ц..., Ц...""")
      ...
      with st.expander("7. Антикорупційне застереження"):
         ...
         init_change = st.button("Змінити", key=7)
         if init_change:
            st.error("""Внесення змін до цього розділу потребуватиме погодження
                     таких підрозділів: Ц..., Ц..., Ц...""")
      ...
      with st.expander("8. Порядок вирішення спорів"):
         ...
         init_change = st.button("Змінити", key=8)
         if init_change:
            st.error("""Внесення змін до цього розділу потребуватиме погодження
                     таких підрозділів: Ц..., Ц..., Ц...""")
      ...
      with st.expander("9. Застереження про конфіденційність"):
         ...
         init_change = st.button("Змінити", key=9)
         if init_change:
            st.error("""Внесення змін до цього розділу потребуватиме погодження
                     таких підрозділів: Ц..., Ц..., Ц...""")
      ...
      with st.expander("10. Інші умови договору"):
         ...
         init_change = st.button("Змінити", key=10)
         if init_change:
            st.error("""Внесення змін до цього розділу потребуватиме погодження
                     таких підрозділів: Ц..., Ц..., Ц...""")
      ...
      with st.expander("11. Термін дії Договору"):
         ...
         st.caption("""11.2 Зміни в цей Договір можуть бути внесені за взаємною згодою Сторін та 
         оформляються додатковою угодою до цього Договору.""")

         init_change = st.button("Змінити", key=11)
         if init_change:
            st.error("""Внесення змін до цього розділу потребуватиме погодження
                     таких підрозділів: Ц..., Ц..., Ц...""")
      ...
      with st.expander("12. Додатки до договору"):
         ...
         init_change = st.button("Змінити", key=12)
         if init_change:
            st.error("""Внесення змін до цього розділу потребуватиме погодження
                     таких підрозділів: Ц..., Ц..., Ц...""")
